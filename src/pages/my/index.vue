...
<template>
  <view class="my-header" :style="{ marginTop: `${statusBarHeightRef}px` }">
    <image class="my-avatar" :src="userInfo.avatar" />
    <view class="my-username">
      「{{ userInfo.username }}」 {{ userInfo.nickname }}
    </view>
    <view class="my-userID">
      ID: {{ userInfo.id }}
    </view>
  </view>
  <view class="my-menu-list">
    <view class="my-menu-group">
      <view class="my-menu-item">
        <text class="fs-40 i-carbon-calculator" />
        <text class="flex-1">预算管理</text>
        <text class="i-carbon-chevron-right" />
      </view>
      <view class="my-menu-item">
        <text class="fs-40 i-carbon-tag" />
        <text class="flex-1">类别管理</text>
        <text class="i-carbon-chevron-right" />
      </view>
      <view class="my-menu-item">
        <text class="fs-40 i-carbon-settings" />
